...
let zerotaskstatus = value => {
    switch(value){
        case 1:  return value='待审核'

        case 2: return  value='审核通过'

        case 3: return  value='运行中'

        case 4: return  value='暂停中'

        case 5: return  value='暂停中'

        case 6: return  value='已完成'

        case 7: return  value='退还手续费中'

        case 8: return  value='已取消'
    }
}
