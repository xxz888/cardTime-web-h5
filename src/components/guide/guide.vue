  ...
  <div class="guide" v-if="$store.state.user.guide">
    <div class="box">
      <img class="guide_skip" @click="quit()"
           src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/guide/guide_skip.png"/>
      <img :class="'operation'+step" @click="next"
           :src="'https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/guide/'+step+'.png'"/>
      <img :class="'step'+step"
           :src="'https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/guide/guide'+step+'.png'"/>
    </div>
  </div>
</template>
<script>
