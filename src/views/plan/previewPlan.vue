<template>
  <div>
    ...
    <confirmorcancel ref="endPlan" src='https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/alert.png' but='1'
    ...
    <confirmorcancel ref="causeMessage" src='https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/alert.png'
                     but='3' :zi='start'/>
    <confirmorcancel ref="Dialog" src='https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/alert.png' but='1'
