<template>
  <div>
    ...
    <confirmorcancel ref="Dialog" src='https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/alert.png' but='3'
                     :zi='start'/>
...
.pre_bg {
  height: 244px;
  width: 210px;
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/zero/pre_bg.png") center no-repeat;
