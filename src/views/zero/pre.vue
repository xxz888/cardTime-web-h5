<template>
  <div>
    ...
    <div class="">
      ...
      <div class="pre_cont">
        <img class="user_icon" src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/zero/user_icon.png"
             alt="">
        ...
        <div class="phone" v-if="prepreUserPhone!='' &&  prepreUserPhone!=null">
          ...
          <a :href="'tel:'+prepreUserPhone" class="user_right">
            <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/zero/phone_iocn.png" alt="">
          </a>
        </div>
        <div class="tips">
...
.pre_bg_t {
  height: 150px;
  width: 100%;
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/zero/pre_bg_t.png") center no-repeat;
...
.pre_bg_b {
  ...
  position: fixed;
  bottom: 0;
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/zero/pre_bg_b.png") center no-repeat;
  background-size: 100% 100%;
}
