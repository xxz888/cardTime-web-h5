<template>
  <div>
    ...
    <diyconfirm ref="confirm" src='https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/alert.png' but='1'
    ...
    <confirmorcancel ref="Dialog" src='https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/alert2.png' but='2'
...
.to_top {
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/toTop.png") center no-repeat;
  background-size: 100% 100%;
  height: 50px;
  width: 50px;
  position: fixed;
...
.detail_doubt_icon {
  ...
  width: 15px;
  display: inline-block;
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/doubt_icon.png") center no-repeat;
  background-size: 100% 100%;
