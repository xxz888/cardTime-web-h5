      ...
      <div class="bill_tab_box">
        <div class="bill_tab">
          <ul class="bill_tab_type van-hairline--bottom">
            <li class="item" :class="type==1?'typeActive':''" @click="typeChange(1)">
              <img v-if="type==1"
                   src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/bill/quick_icon_on.png" alt="">
              <img v-else src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/bill/quick_icon_off.png"
                   alt="">
              <div>刷卡记录</div>
            </li>
            <li class="item" :class="type==2?'typeActive':''" @click="typeChange(2)">
              <img v-if="type==2"
                   src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/bill/creditcard_icon_on.png"
                   alt="">
              <img v-else
                   src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/bill/creditcard_icon_off.png"
                   alt="">
              <div>还款记录</div>
            </li>
            <li class="item" :class="type==3?'typeActive':''" @click="typeChange(3)">
              <img v-if="type==3"
                   src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/bill/zero_icon_on.png" alt="">
              <img v-else src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/bill/zero_icon_off.png"
                   alt="">
              <div>空卡记录</div>
            </li>
          </ul>
              ...
              <li class="pay_item" v-for="item in quickList" @click='detail(item,"quickDetail")' :key="item.key">
                <div class="pay_item_top van-hairline--bottom">
                  ...
                  <div class="quick_status">
                    ...
                    <div :class="'brushStatus'+item.status">{{ item.status |status }}</div>
                  </div>
                </div>
              </li>
            </ul>
              ...
              <li class="pay_item" v-for="item in payList" :key="item.key">
                ...
                <div v-if="item.planType==2">
                  ...
                  <div class="pay_item_detail" @click='detail(item,type,item.planType)'>
                    ...
                    <div class="right">
                      <span>查看详情</span>
                      <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/right_icon.png" alt="">
                    </div>
                  </div>
                </div>
                <div v-else>
