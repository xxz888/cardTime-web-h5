    ...
    <van-sticky :offset-top="46">
      <div class="profit_user_search">
        ...
        <div class="right" @click="statusTrueFalseBy=true">
          ...
          <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/profit/bottom_icon.png" alt="">
        </div>
      </div>
    </van-sticky>
      ...
      <div>
        <van-list v-model="isupLoading" :finished="finished" finished-text="没有更多了" @load="onLoad">
          <ul class="profit_user_list" v-if="sonList.length>0">
            <li class="profit_user_item_box" v-for="(item,index) in sonList" :key="index">
              <div class="profit_user_item">
                <div class="left">
                  <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/img_icon.png" alt="">
                </div>
                <div class="cont">
                ...
                <div class="right">
                  <div class="phone">
                    ...
                    <a v-if="title=='直推用户'" :href="'tel:'+item.phone">
                      <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/profit/phone_icon.png"
                           alt="">
                    </a>
                  </div>
          ...
          <van-empty class="user_empty" v-else
                     image="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/user_empty.png" description="还没有直推用户
            请前去立即推广哦">
