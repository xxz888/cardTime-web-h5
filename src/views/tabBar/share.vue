    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh" loading-text="加载中...">
      <div>
        <div class="top">
          ...
          <ul class="top_list">
            <li class="top_item">
              <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_brand_icon.png"
                   alt="">
              <p>平台稳定运维</p>
              <p><span class="theme">{{ falsebrand.anniversary }}</span>周年</p>
            </li>
            <li class="top_item">
              <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_register_icon.png"
                   alt="">
              <p>累计注册人</p>
              <p><span class="theme">{{ number(falsebrand.registerNumber) }}</span>人</p>
            </li>
            <li class="top_item">
              <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_transactionicon.png"
                   alt="">
              <p>日均交易量</p>
        ...
        <div class="cont">
          <ul class="menu_list van-hairline--bottom">
            <li class="menu_item" @click="next('/library','8')">
              <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_material_icon.png"
                   alt="">
              <div>分享素材</div>
            </li>
            <li class="menu_item" @click="next('/sharePage','8')">
              <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_spread_icon.png"
                   alt="">
              <div>推广二维码</div>
            </li>
            <li class="menu_item" @click="$router.push('/regulation')">
              <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_profit_icon.png"
                   alt="">
              <div>收益规则</div>
            </li>
          </ul>
          <div class="cell_box">
            <ul class="cell_list">
              <li class="cell_item van-hairline--bottom" @click="next('/partnerBusiness','8')">
                <div class="left">
                  <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/spread_icon.png" alt="">
                  <span>推广物料</span>
                </div>
                <div class="icon">
              ...
              <li class="cell_item van-hairline--bottom" @click="next('/wechat','8')">
                <div class="left">
                  <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/wechat_icon.png" alt="">
              ...
              <li class="cell_item van-hairline--bottom" @click="link('特训营')">
                <div class="left">
                  <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/share_training_icon.png"
                       alt="">
                  <span>新代理育龙特训营</span>
                </div>
                <div class="icon">
              ...
              <li class="cell_item van-hairline--bottom" @click="next('/videoTudorial','8')">
                <div class="left">
                  <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/explain_icon.png"
                       alt="">
                  <span>机构政策</span>
                </div>
                <div class="icon">
              ...
              <li class="cell_item van-hairline--bottom" @click="link('平台介绍')">
                <div class="left">
                  <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/introduce_icon.png"
                       alt="">
                  <span>平台介绍</span>
                </div>
                <div class="icon">
...
.top .bg {
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/share/top_bg.png") center no-repeat;
