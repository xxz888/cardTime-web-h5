  ...
  <div>
    ...
    <div class="warpper">
      ...
      <div class="card_box">
        <div class="card_item">
          ...
          <div class="card_item_add">
            <img
              :src="imgUrl==''?'https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/card/add_card_icon.png':imgUrl"
              @click="scanCard()" alt="">
            <div>请点击拍摄储蓄卡正面</div>
          </div>
      ...
      <div class=" upcreditcard_btn_box">
        <van-button @click.native="add()" type="primary" class=" upcreditcard_btn " round>添加储蓄卡</van-button>
      </div>
    </div>
