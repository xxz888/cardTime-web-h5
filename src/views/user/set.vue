...
<template>
  <div>
    ...
    <div class="main">
      <van-cell-group>
        <van-cell title="设置登录密码" icon="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/set/key_icon.png"
                  is-link to="userpassword">
        </van-cell>
        <van-cell title="修改交易密码"
                  icon="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/set/password_icon.png" is-link
                  to="password"/>
      </van-cell-group>
