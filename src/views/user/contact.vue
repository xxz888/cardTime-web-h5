  ...
  <div class="kf_block">
    ...
    <div class="main ">
      <div class="contact_top theme">
        <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/contact/logo.png" alt="">
      ...
      <div v-if="geMeiqia" style="margin-top: -44px" class="item" @click="meiqia">
        <div class="item_left">
          <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/contact/kf_btn_online_icon.png" alt="">
          <span>在线客服</span>
        </div>
        <div class="item_right">
          <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/contact/right.png" alt="">
        </div>
      </div>
      ...
      <div class="item" @click="gonext('feedback')">
        <div class="item_left">
          <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/contact/kf_btn_tousu_icon.png" alt="">
          <span>投诉建议</span>
        </div>
        <div class="item_right">
          <img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/contact/right.png" alt="">
...
.contact_top {
  width: 100%;
  height: 220px;
  background: url("https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/contact/kf_top_bg.png") no-repeat;
