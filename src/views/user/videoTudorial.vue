...
<template>
  <div>
    ...
    <div class="main">
      <img width="100%" src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/organization.jpg">
      <van-divider dashed :style="{ borderColor: '#aaa' }"><h4>卡德世界运营服务机构政策</h4></van-divider>
      <ul>
        <li>1、申请成立机构需要100㎡以上的办公场地，配套基础办公设备、茶室、会议室。</li>
        <li>2、申请人具有法人资格和公司主体。</li>
        <li>3、设立机构的目的，为当地代理商和用户提供培训服务，负责卡德世界在当地的品牌宣传，维护卡德世界在当地的市场秩序。</li>
        <li>4、机构在享有卡德世界三级分润制度和三级奖励制度、顶级代理底薪制度和顶级团队管理奖制度的基础上，给予运营服务机构最高还款交易流水无限代万2的运营补贴。</li>
      ...
      <div class="organization">
        ...
        <div class="long"></div>
        <ul>
          <li><span><img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/1.png"></span>
            <h3 style="color:rgb(255,76,89)">1、申请成立运营服务机构</h3></li>
          <li><span><img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/2.png"></span>
            <h3>2、总部面试</h3></li>
          <li><span><img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/3.png"></span>
            <h3>3、查验办公场地</h3></li>
          <li><span><img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/4.png"></span>
            <h3>4、签订机构协议</h3></li>
          <li><span><img src="https://cader-install.oss-cn-shanghai.aliyuncs.com/backManage/5.png"></span>
            <h3>5、成为合作伙伴</h3></li>
        </ul>
      </div>
